...
//product
Router.post('/createProduct', upload.single('image'), controller_product.createProduct);
Router.get("/getAllProducts", controller_product.getAllProducts);
Router.patch('/updateProduct/:id', upload.single('image'), controller_product.updateProduct);
